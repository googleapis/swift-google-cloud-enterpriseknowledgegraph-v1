  ...
  Sendable
{
  ...
  /// request.
  public var entityReconciliationJobs: [EntityReconciliationJob] = []
  ...
  /// Initialize a new instance of `ListEntityReconciliationJobsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEntityReconciliationJobsResponse().with { $0.entityReconciliationJobs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let entityReconciliationJobs = CodingKeys(stringValue: "entityReconciliationJobs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [EntityReconciliationJob].self, forKey: .entityReconciliationJobs)
    {
      self.entityReconciliationJobs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.entityReconciliationJobs, forKey: .entityReconciliationJobs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return
      "type.googleapis.com/google.cloud.enterpriseknowledgegraph.v1.ListEntityReconciliationJobsResponse"
  }
