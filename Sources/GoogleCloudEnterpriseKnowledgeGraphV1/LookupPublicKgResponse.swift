...
public struct LookupPublicKgResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LookupPublicKgResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LookupPublicKgResponse().with { $0.context = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.enterpriseknowledgegraph.v1.LookupPublicKgResponse"
  }
