  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let bigqueryInputConfigs = CodingKeys(stringValue: "bigqueryInputConfigs")
    static let entityType = CodingKeys(stringValue: "entityType")
    static let previousResultBigqueryTable = CodingKeys(stringValue: "previousResultBigqueryTable")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [BigQueryInputConfig].self, forKey: .bigqueryInputConfigs)
    {
      self.bigqueryInputConfigs = value
    }
    if let value = try container.decodeIfPresent(InputConfig.EntityType.self, forKey: .entityType) {
      self.entityType = value
    }
    if let value = try container.decodeIfPresent(
      Swift.String.self, forKey: .previousResultBigqueryTable)
    {
      self.previousResultBigqueryTable = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.bigqueryInputConfigs, forKey: .bigqueryInputConfigs)
    try container.encode(self.entityType, forKey: .entityType)
    try container.encode(self.previousResultBigqueryTable, forKey: .previousResultBigqueryTable)
